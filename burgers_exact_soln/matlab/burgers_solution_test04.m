function burgers_solution_test04 ( )

%*****************************************************************************80
%
%% burgers_solution_test04() tests sets up a small test case for solution #2.
%
%  Licensing:
%
...
%
  ...
  fprintf ( 1, '\n' );
  fprintf ( 1, 'burgers_solution_test04():\n' );
  ...
  ylabel ( '<--- T --->' );
  zlabel ( '<--- U(X,T) --->' );
  title ( 'burgers\_solution\_test04' )
